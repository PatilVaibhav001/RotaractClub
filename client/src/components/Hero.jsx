      ...
      <div className="flex flex-col-reverse gap-10 md:flex-row px-4 md:px-16 lg:px-24 xl:px-32 items-center"> 
        <div className="max-md:text-center flex-1">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mt-6">
                <Link to="/login" className="px-8 py-3 rounded-md bg-indigo-600 hover:bg-indigo-700 text-white active:scale-95 transition-all text-center">
                    Get Started
                </Link>
                <Link to="/login" className="px-5 py-3 rounded-md bg-white text-indigo-600 border border-indigo-400 flex items-center justify-center gap-2 hover:bg-indigo-600/5 active:scale-95 transition-all">
